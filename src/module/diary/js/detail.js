  ...
  detailData:{
    diaryDetail:{
      ...
      listComment:{ //评论
        ...
        getMore:{ //获取更多评论
          url:"/portal/diaryAction!listMoreComment.action",
          hasMore:false,
          data:{
            lastCommentId:"",
            size:10,
        ...
        send:{ //发送
          url:"/portal/diaryAction!commitComment.action",
          contentObject:'tbQyDiaryCommentPO.content',//传送的内容字符串
          data:{}
        },
        delete:{ //删除
          url:"/portal/diaryAction!deleteComment.action",
